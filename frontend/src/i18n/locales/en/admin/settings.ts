export default {
    settings: {
      ...
      openaiFastPolicy: {
        ...
        apiKeysHint: 'Search by key name. Leave empty to match all gateway keys; cannot be combined with specific users.',
        apiKeySearchPlaceholder: 'Search API key name',
        apiKeySearchEmpty: 'No matching API keys found',
        apiKeyIdFallback: 'API key #{id}',
        apiKeyUser: 'User #{id}',
        ...
        includeMissingTier: 'Also match requests without service_tier',
        errorMessage: 'Error message',
        errorMessagePlaceholder: 'Custom error message when blocked',
