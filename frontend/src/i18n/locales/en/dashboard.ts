export default {
  ...
  keys: {
    ...
    regenerateKeyConfirmMessage: "Are you sure you want to regenerate '{name}'? The old key will stop working immediately.",
    id: 'ID',
    apiKey: 'API Key',
    group: 'Group',
    ...
    keyRegeneratedSuccess: 'API key regenerated; the old key is no longer valid',
