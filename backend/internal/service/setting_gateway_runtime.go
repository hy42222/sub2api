...
// GetOpenAICodexClientVersion returns the configured, synced, or built-in Codex version.
...
// GetOpenAICodexCanonicalUserAgent keeps the selected UA identity paired with the active version.
